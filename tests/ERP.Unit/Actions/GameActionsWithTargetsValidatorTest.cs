...
public class GameActionsWithTargetsValidatorTest
{
    ...
    private static ActionWithTargetsAvailability AVAILABILY_ONE_PROMPT_VALUES_MIN_1_MAX_1 = new ActionWithTargetsAvailability
    {
        ActionName = "blabla",
    ...
    private static ActionWithTargetsAvailability AVAILABILITY_SINGLE_PROMPT_MIN_1_MAX_1_ = new ActionWithTargetsAvailability
    {
        ActionName = "blabla",
    ...
    private static List<List<ActionTarget>> ONE_PROMPT_MANY_SELECTIONS_ACTION_TARGET = [[ANY_TARGET_WITH_ID_1, ANY_TARGET_WITH_ID_2]];
    private static List<List<ActionTarget>> ONE_PROMPT_TOO_MANY_SELECTIONS_ACTION_TARGET = [[ANY_TARGET_WITH_ID_1, ANY_TARGET_WITH_ID_2, ANY_TARGET_WITH_ID_3, ANY_TARGET_WITH_ID_4]];
    ...
    // TODO: test to check if comparisons still work with values instead of ids
}